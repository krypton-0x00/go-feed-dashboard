...
const features = [
  ...
  {
    title: "Customizable",
    description: "Customize Go Feed to fit your needs and preferences.",
    icon: "icon-2",
  },
  {
    title: "Analytics",
  ...
  {
    title: "Secure",
    description: "Your data is safe and secure with Go Feed.",
  },
  {
    title: "Scalable",
    description: "Grow your business with Go Feed as you scale.",
  },
  {
    title: "Fast Support",
